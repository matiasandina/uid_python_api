...
from doric_system_defs import StructureWithEnums, Channel, TriggerType, TriggerMode
...
class LightSourceComplexModulation(StructureWithEnums):
    ...
    _map = {"mode": LightSourceComplexMode}
...
class LightSourceSettings(StructureWithEnums):
    ...
    _map = {
        ...
        "currentMode": LightSourceCurrentMode,
    }
    ...
    def __init__(self):
        ...
        self.triggerType = TriggerType.Manual
        self.triggerMode = TriggerMode.Uninterrupted
        self.isTriggerRepeatable = False
        self.currentMode = LightSourceCurrentMode.Normal
        self.ttlModulation = LightSourceTTLModulation()

        self.customDataPoint = (c_uint16 * 1000)()
        for point_id in range(1000):
            self.customDataPoint[point_id] = 0
